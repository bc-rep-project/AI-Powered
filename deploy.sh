...
pip install PyJWT>=2.4.0 requests>=2.27.0 fastapi>=0.100.0 uvicorn>=0.18.0 pydantic>=2.0.0 pydantic-settings>=2.0.0 sqlalchemy>=1.4.0 psycopg2-binary>=2.9.3 email-validator>=2.0.0
